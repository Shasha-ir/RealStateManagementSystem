...
public class SellerRegisterPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        agencyInsert = new javax.swing.JTextField();
        ...
        titleLabel.setText("Register as a Seller");
        ...
        gridBagConstraints.insets = new java.awt.Insets(72, 56, 0, 57);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(51, 79, 0, 0);
        ...
        gridBagConstraints.ipadx = 10;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(30, 132, 0, 0);
        ...
        gridBagConstraints.gridwidth = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(49, 156, 27, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(49, 77, 27, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(49, 5, 27, 0);
        getContentPane().add(homeButton, gridBagConstraints);

        agencyLabel.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        ...
        getContentPane().add(agencyLabel, gridBagConstraints);
        ...
        agencyInsert.setFont(new java.awt.Font("Segoe UI Semibold", 0, 18)); // NOI18N
        agencyInsert.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agencyInsertActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 6;
        ...
        getContentPane().add(agencyInsert, gridBagConstraints);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        String agency = agencyInsert.getText().trim();
        String password = passwordInsert.getText().trim();

        // Validate that all fields are filled
        if (name.isEmpty() || email.isEmpty() || phoneNumber.isEmpty() || agency.isEmpty() || password.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please complete all fields", "Input Error", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Validate that the password is less than 10 characters
        if (password.length() > 10) {
            javax.swing.JOptionPane.showMessageDialog(this, "Password must be less than 10 characters", "Password Error", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Create a new Seller object
        Seller newSeller = new Seller(0, name, email, phoneNumber, agency, password);

        // Insert the seller into the database
        SellerController sellerController = new SellerController();
        boolean isInserted = sellerController.addSeller(newSeller);
        ...
        if (isInserted) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Failed to register seller. Try again.", "Database Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void agencyInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agencyInsertActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_agencyInsertActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SellerRegisterPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SellerRegisterPage().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField agencyInsert;
