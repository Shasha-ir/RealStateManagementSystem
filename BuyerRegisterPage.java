...
public class BuyerRegisterPage extends javax.swing.JFrame {

    /**
     * Creates new form BuyerRegisterPage
     */
    public BuyerRegisterPage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Register as a Buyer");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(51, 29, 0, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(56, 150, 6, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(56, 42, 6, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(56, 6, 6, 0);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        Buyer newBuyer = new Buyer(0, name, email, phoneNumber, password);

        // Insert the buyer into the database
        BuyerController buyerController = new BuyerController();
        boolean isInserted = buyerController.addBuyer(newBuyer);
        ...
        if (isInserted) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Failed to register buyer. Try again.", "Database Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuyerRegisterPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuyerRegisterPage().setVisible(true);
            }
        });
    }
